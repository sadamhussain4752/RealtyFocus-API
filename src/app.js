...
const LegalapprovalRoute = require('./routes/AddLegalapprovalRoutes/AllLegalapprovalRoutes');
...
const PropstatusRoutes = require('./routes/AddPropstatusRoutes/AllPropstatusRoutes');
const PropTypeRoutes = require('./routes/AddPropTypeRoutes/AlllistPropTypeRoutes');
...
app.use('/api/legalapproval', LegalapprovalRoute);
